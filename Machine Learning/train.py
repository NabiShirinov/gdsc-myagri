...
#Read the data
input_d = pd.read_csv(r"C:\xampp\htdocs\rainforest\Machine Learning\_prepared_input.csv",header=None)
output_d = pd.read_csv(r"C:\xampp\htdocs\rainforest\Machine Learning\_prepared_output.csv",header = None)
